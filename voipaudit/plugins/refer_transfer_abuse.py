...
ALWAYS a hardcoded, synthetic, fictional extension
    ...
    def scan(self, target: str, **kwargs: Any) -> list[Finding]:
        ...
        try:
            result = safe_transfer_probe(
                ...
                tls_verify=self.tls_verify, refer_wait_timeout=self.refer_wait_timeout,
            )
            ...
            return Finding(
                ...
                description=(
                    ...
                    + " — the target's signalling indicates it accepted (and, per the NOTIFY, at "
                      ...
                      "the REFER itself, not a confirmed real-destination transfer."
                ),
